...
class TicktokRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TicktokRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const TicktokRequest& from) {
    TicktokRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void HelloResponse::set_reply_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.reply_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HelloResponse::set_allocated_reply_message(std::string* reply_message) {
  ...
  _impl_.reply_message_.SetAllocated(reply_message, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
